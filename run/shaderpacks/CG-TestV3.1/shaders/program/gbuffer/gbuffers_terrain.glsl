...
#if ANISOTROPIC_FILTER > 0
    #include "/lib/materials/anisotropicFiltering.glsl"
#endif
...
#ifdef SNOWY_WORLD
    #include "/lib/materials/snowyWorld.glsl"
#endif
...
void main() {
    ...
    vec3 worldGeoNormal = normalize(ViewToPlayer(geoNormal * 10000.0));
        ...
        #include "/lib/others/showLightLevels.glsl"
    #endif
...
void main() {
    ...
    #if ANISOTROPIC_FILTER > 0
        if (mc_Entity.y > 0.5 && dot(normal, upVec) < 0.999) absMidCoordPos = vec2(0.0);
    #endif
    ...
    gl_Position = gl_ProjectionMatrix * gbufferModelView * position;
        ...
        if (mat == 10257) gl_Position.z -= 0.00001;
    #endif
