...
void main() {
    ...
    float smoothnessD = 0.0, skyLightFactor = 0.0, materialMask = OSIEBCA * 254.0;
    vec3 normalM = normal;
    ...
    if (alphaCheck > 0.001) {
        ...
        bool noSmoothLighting = atlasSize.x < 600.0;
        ...
        vec3 shadowMult = vec3(1.0);
            ...
            #include "/lib/materials/entityMaterials.glsl"
                ...
                #include "/lib/materials/irisMaterials.glsl"
            #endif
            ...
            } else if (entityId == 50008) {
                noSmoothLighting = true;
            } else if (entityId == 50076) {
                playerPos.y += 0.38;
            }
        #endif
        ...
        normalM = gl_FrontFacing ? normalM : -normalM;
...
void main() {
    ...
    sunVec = GetSunVector();
        ...
        if (entityId == 50008 || entityId == 50012) {
