...
#include "/lib/pipelineSettings.glsl"
    ...
    #include "/lib/text/textRenderer.glsl"
...
void main() {
    ...
    for (int i = 0; i < 8; i++) {
        ...
        #include "/lib/text/error_optifine_af.glsl"
    #elif defined OPTIFINE_ACL_ERROR
        #include "/lib/text/error_optifine_acl.glsl"
    #elif defined APPLE_ACL_ERROR
        #include "/lib/text/error_apple_acl.glsl"
    #else
            ...
            if (max(absCameraPositionIntXZ.x, absCameraPositionIntXZ.y) > 8388550) {
                #include "/lib/text/error_coordinates_acl.glsl"
            }
        #endif
        #ifdef SHADOWDISTANCE_ACL_ERROR
            if (COLORED_LIGHTING_INTERNAL > shadowDistance*2) {
                #include "/lib/text/error_shadowdistance_acl.glsl"
            }
        #endif
    #endif
