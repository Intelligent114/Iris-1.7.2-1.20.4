...
#ifdef CONNECTED_GLASS_EFFECT
    #include "/lib/materials/connectedGlass.glsl"
#endif
...
void main() {
    vec4 color1 = texture2DLod(tex, texCoord, 0);
        ...
        if (mat == 32000) {
            ...
            vec3 worldPosM = worldPos;
                ...
                #define WATER_FOG_MULT_M_DEF WATER_FOG_MULT * 0.01
                worldPosM *= WATER_FOG_MULT_M_DEF;
            #endif
            ...
            #ifdef CONNECTED_GLASS_EFFECT
                if (mat == 30008 || (mat >= 31000 && mat < 32000)) {
                    DoSimpleConnectedGlass(color1);
                    #if defined LIGHTSHAFTS_ACTIVE && LIGHTSHAFT_BEHAVIOUR == 1 && defined OVERWORLD
                        positionYM = 0.0;
                    #endif
    ...
    #if SHADOW_QUALITY >= 1
        #if defined LIGHTSHAFTS_ACTIVE && LIGHTSHAFT_BEHAVIOUR == 1 && defined OVERWORLD
            color2.a = 0.25 + max0(positionYM * 0.05);
        #endif
...
#include "/lib/util/spaceConversion.glsl"
    ...
    #ifdef PUDDLE_VOXELIZATION
        #include "/lib/others/puddleVoxelization.glsl"
    #endif
#endif
