...
#define PHYSICS_OCEAN_INJECTION
    ...
    lmCoordM.y = min(lmCoord.y * 1.07, 1.0);
    ...
    reflectMult = 1.0;
        ...
        vec3 normalMap = vec3(0.0, 0.0, 1.0);
            ...
            normalM = mix(normalM, normal, norMix);
        ...
        if (isEyeInWater != 1) {
            ...
            float underwaterBrightnessFactor = 3;
            color.rgb *= underwaterBrightnessFactor;
