#ifdef POM
    #include "/lib/materials/pomEffects.glsl"
#endif
    ...
    vec2 texCoordM = texCoord;
        ...
        if (!skipPom) {
            ...
            parallaxFade = pow2(lViewPos / POM_DISTANCE);
                ...
                if (entityId == 50008) parallaxFade = 1.1;
            #endif
            #ifdef GBUFFERS_BLOCK
                if (blockEntityId == 5004) parallaxFade = 1.1;
            #endif
            #ifdef GBUFFERS_HAND
                if (heldItemId == 40004 || heldItemId2 == 40004) parallaxFade = 1.1;
            #endif
        ...
        normalM = pow(normalM, vec3(NORMAL_MAP_STRENGTH * 0.007));
        normalM -= vec3(0.5, 0.5, 0.0);
